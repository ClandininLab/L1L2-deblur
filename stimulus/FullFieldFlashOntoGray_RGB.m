% FullFieldFlashOntoGray_RGB.m
% 
% Version of FullFieldFlashOntoGray that works with lightcrafter
...
%  FullFieldFlashOntoGray and not 3X the resolution, though this
...
classdef FullFieldFlashOntoGray_RGB < Stimulus 
    properties 
        Out
    ...
    methods
        ...
        function obj = FullFieldFlashOntoGray_RGB(txtFile)
...
%             currFrame = 1; 
            ...
            for currFrame = 1:totalFrames 
                ...
                if epochFrameCount == 0 && isGray == 1 
                    ...
                    contrast = convertInt2RGB(repmat(flashContrast(k),1,3));
                ...
                elseif epochFrameCount == 0 && isGray == 0
                    contrast = convertInt2RGB(repmat(gray,1,3));
                ...
                rawStim(currFrame) = thisFrameContrast(1);
