...
classdef WhiteNoise_1D_FullFieldFlash_flipsparse < Stimulus 
    properties 
        Out
    ...
    methods
        % Constructor
        function obj = WhiteNoise_1D_FullFieldFlash_flipsparse(txtFile)
...
%                 [VBLTimestamp StimulusOnsetTime FlipTimestamp Missed Beampos] = 
                Screen('Flip', window, startTime + currFrame*duration);  
                pause(0)
                end
