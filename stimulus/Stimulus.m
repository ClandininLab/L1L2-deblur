...
%   12/3/21 - changed photodiode patch size
%
% Last update: 12/3/21 MMP
%
...
classdef (Abstract) Stimulus < handle
    ...
    properties
        ...
        screenDim = [130 0 700 1140]; % top L & bottom R coordinates
        pdDim = [30 0 90 120]; % photodiode coordinates 2021 MMP updated
        RGBscale = 63/255; % correction for 6-bit color coding
        
        % struct that defines physical distances (in cm)
        physDist = struct('fly2scrnLL', 14.2,... % fly to screen lower left corner
            'fly2scrnLR', 12.8,... % fly to screen lower right corner
            'fly2scrnUL', 8.7,... % fly to screen upper left corner
            'fly2scrnUR', 6.2,... % fly to screen upper right corner
            'fly2horizL', 8.2,... % fly horizontally to vertical plane of screen, left side
            'fly2horizR', 5.7,... % fly horizontally to vertical plane of screen, right side
            'fly2topL', 2.5,... % horizontal plane of fly to screen top, vertically, on left
            'fly2topR', 2.5,... % horizontal plane of fly to screen top, vertically, on right
