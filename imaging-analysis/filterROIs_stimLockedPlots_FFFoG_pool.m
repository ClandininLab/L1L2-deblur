% filterROIs_stimLockedPlots_FFFoG_pool.m 
%
...
function [roiMatNew, iResp, iInv, framesPerLDCycle] = ...
    filterROIs_stimLockedPlots_FFFoG_pool(roiMat, refColumn, pairedEpochs, ...
...
%     refEpochDur = roiMat(1,1).stimDat.obj.Duration{1}*2;
    ...
    for r = 1:size(roiMat, 1)
        ...
        [meanResp, stdErr, t] = ...
            compute_meanResp_err_moveAvg_FFFoG_pool(roiMat(r,nonRefCols),...
