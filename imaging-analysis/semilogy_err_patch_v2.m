...
%   g - handle to line
%
function g=semilogy_err_patch_v2(x,y,e,col1,col2,style)
...
if(nargin==6)
    g=semilogy(x,y,'color',col1,'linewidth',2,'linestyle',style);
else
    g=semilogy(x,y,'color',col1,'linewidth',2);
end
