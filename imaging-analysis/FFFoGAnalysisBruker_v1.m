...
timeseriesInd = find(i_L1_glusnfr_geco1a .*i_M1 .* (~metaDat.isMoving) .*...
    (i_300msSearchStimFlashRGB + i_fullfield_LDflash20ms_Gray500ms));

refStimCode = '300ms_searchStimFlash_RGB';
nrefStimCode = {'fullfield_LDflash20ms_Gray500ms_RGB'};
...
nrefPlotTitle = 'fullfield_LDflash20ms_Gray500ms_RGB';
saveName = 'fullfield_LDflash20ms_Gray500ms_RGB';
inv = 0;
