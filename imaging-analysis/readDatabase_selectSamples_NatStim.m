...
%
%filename = '/Users/hyang/Documents/naturalisticStim/TestAquisition_210622/NatStim_L2_ASAP2f_jRGECO1b.txt';
filename = '/Volumes/LEGTRACKING/L1L2_Michelle/220220/NatStim_L2_ASAP2f_jRGECO1b.txt';
...
i_fullfield_LDflash20ms200ms_Gray750ms = strcmpi('fullfield_LDflash20ms200ms_Gray750ms', stimcode);
i_fullfield_LDflash20ms_Gray500ms = strcmpi('fullfield_LDflash20ms_Gray500ms', stimcode);
i_fullfield_LDflash20ms_Gray500ms_RGB = strcmpi('fullfield_LDflash20ms_Gray500ms_RGB', stimcode);
i_fullfield_LDflash20ms_Gray500ms = i_fullfield_LDflash20ms_Gray500ms | i_fullfield_LDflash20ms_Gray500ms_RGB;
...
i_300msSearchStimFlashRGB = strcmpi('300ms_searchStimFlash_RGB', stimcode);
i_300msFFF_RGB = strcmpi('300msFFF_binarycontrast_RGB', stimcode);

% wavelength
i_920 = (wavelength == 920);
i_1050 = (wavelength == 1050);
...
% iGluSnFR and JRGECO1a
i_L1_glusnfr_geco1a = strcmpi('L1-SFiGluS72A-GECO1a', genotype);
